extern class TabButton extends dijit.form.ToggleButton {
...
typedef Utils = {
	function layoutChildren(container:HTMLElement, dim:Dynamic, children:Array<dijit._WidgetBase>, changedRegionId:String, changedRegionSize:Float):Void;
