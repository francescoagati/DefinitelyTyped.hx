extern class FilterBuilder {
	function new():Void;
	var defaultArgs : Dynamic;
	var supportedOps : Dynamic;
	var supportedTypes : Dynamic;
	function buildExpression(def:Dynamic):Dynamic;
}
extern class FilterDefDialog {
	function new(args:Dynamic):Void;
	var curColIdx : Float;
	var plugin : Dynamic;
	function addCriteriaBoxes(cnt:Float):Void;
	function canFilter():Bool;
	function clearFilter(noRefresh:Dynamic):Void;
	function closeDialog():Void;
	function destroy():Void;
	function getColumnLabelByValue(v:Dynamic):Dynamic;
	function getColumnType(colIndex:Float):Dynamic;
	function getConditionLabelByValue(type:Dynamic, c:Dynamic):Dynamic;
	function getCriteria(idx:Float):Dynamic;
	function getExprForColumn(value:Dynamic, colIdx:Dynamic, type:Dynamic, condition:Dynamic):Dynamic;
	function getExprForCriteria(rule:Dynamic):Dynamic;
	function getFilter():Dynamic;
	@:overload(function(cnt:Dynamic, isIdx:Bool):Void { })
	@:overload(function(cnt:Array<Float>, isIdx:Bool):Void { })
	function removeCriteriaBoxes(cnt:Float, isIdx:Bool):Void;
	function setFilter(rules:Dynamic, ruleRelation:Dynamic):Void;
	function showDialog(colIndex:Float):Void;
	function onCancel(e:Dynamic):Void;
	function onClearFilter(e:Dynamic):Void;
	function onFilter(e:Dynamic):Void;
	function onMoveColumn(sourceViewIndex:Dynamic, destViewIndex:Dynamic, cellIndex:Dynamic, targetIndex:Dynamic, before:Dynamic):Void;
	function onRendered(cbox:Dynamic):Void;
}
extern class FilterStatusTip {
	function new(args:Dynamic):Void;
	function closeDialog():Void;
	function destroy():Void;
	function showDialog(pos_x:Float, pos_y:Float, columnIdx:Dynamic):Void;
}
extern class ClearFilterConfirm extends dijit._Widget {
	...
	@:overload(function(property:Plugin, value:Dynamic):Void { })
	...
	@:overload(function(property:Plugin):Dynamic { })
	...
	@:overload(function(property:Plugin, callback:{ }):{ function unwatch():Void; } { })
...
extern class FilterBar extends dijit._Widget {
	function new(?params:Dynamic, ?srcNodeRef:HTMLElement):Void;
	var attachScope : Dynamic;
	@:overload(function(property:AttributeMap, value:Dynamic):Void { })
	@:overload(function(property:BaseClass, value:String):Void { })
	...
	function emit(type:String, eventObj:Dynamic, callbackArgs:Array<Dynamic>):Dynamic;
	function getChildren():Array<Dynamic>;
	function getColumnIdx(coordX:Float):Float;
	function getDescendants():Array<Dynamic>;
	function getParent():Dynamic;
	function isFilterBarShown():Bool;
	function isFocusable():Dynamic;
	function isLeftToRight():Dynamic;
	@:overload(function(type:haxe.Constraints.Function, func:haxe.Constraints.Function):Dynamic { })
	function on(type:String, func:haxe.Constraints.Function):Dynamic;
	...
	function postMixInProperties():Void;
	function setAttribute(attr:String, value:Dynamic):Void;
	function showFilterBar(toShow:Dynamic, useAnim:Dynamic, animArgs:Dynamic):Void;
	function startup():Void;
	function subscribe(t:String, method:haxe.Constraints.Function):Dynamic;
	function toggleClearFilterBtn(toHide:Dynamic):Void;
	function toggleFilterBar(useAnim:Dynamic, animArgs:Dynamic):Void;
	function toString():String;
	function uninitialize():Bool;
	function unsubscribe(handle:Dynamic):Void;
	function getCachedTemplate():Dynamic;
