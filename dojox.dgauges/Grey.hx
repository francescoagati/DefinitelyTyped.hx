extern class SemiCircularLinearGauge extends dojox.dgauges.CircularGauge {
	function new(args:Dynamic, node:Dynamic):Void;
...
typedef Utils = {
	function brightness(col:Float, b:Float):Float;
	function createGradient(entries:Array<Dynamic>):Float;
	function genericCircularGauge(scale:Float, indicator:dojox.dgauges.IndicatorBase, originX:Float, originY:Float, radius:Float, startAngle:Float, endAngle:Float, orientation:String, font:Dynamic, labelPosition:String, tickShapeFunc:Dynamic):Float;
};
typedef _circularUtils = { };
