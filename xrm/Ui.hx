...
typedef Grid = {
	function getRows():Collection.ItemCollection<GridRow>;
	function getSelectedRows():Collection.ItemCollection<GridRow>;
	function getTotalRecordCount():Float;
};
typedef GridRow = {
	function getData():GridRowData;
};
typedef GridRowData = {
	function getEntity():GridEntity;
};
typedef GridEntity = {
	function getEntityName():String;
	function getEntityReference():LookupValue;
	function getId():String;
	function getPrimaryAttributeValue():String;
};
typedef ViewSelector = {
	function getCurrentView():ViewSelectorItem;
	function isVisible():Bool;
	function setCurrentView(viewSelectorItem:ViewSelectorItem):Void;
};
typedef ViewSelectorItem = {
	function getEntityReference():LookupValue;
};
