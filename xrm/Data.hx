...
typedef GridControl = {
	>Control,
	function addOnLoad(handler:Void -> Void):Void;
	function getContextType():GridControlContext;
	function getEntityName():String;
	function getGrid():ui.Grid;
	function getViewSelector():ui.ViewSelector;
	function refresh():Void;
	function removeOnLoad(handler:Void -> Void):Void;
};
