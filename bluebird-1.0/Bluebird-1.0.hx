extern class Promise<R> {
	...
	@:overload(function(handler:R -> R):Promise<R> { })
	@:overload(function(handler:R -> Void):Promise<R> { })
	function finally(handler:R -> Promise.Thenable<R>):Promise<R>;
	@:overload(function(handler:R -> R):Promise<R> { })
	@:overload(function(handler:R -> Void):Promise<R> { })
	function lastly(handler:R -> Promise.Thenable<R>):Promise<R>;
	...
	function done<U>(onFulfilled:R -> Promise.Thenable<U>, onRejected:Dynamic -> Promise.Thenable<U>, ?onProgress:Dynamic -> Dynamic):Promise<U>;
	...
	static function promisify(nodeFunction:haxe.Constraints.Function, ?receiver:Dynamic):haxe.Constraints.Function;
