extern class Code extends dijit._Widget {
	...
	@:overload(function(property:ListType, callback:{ }):{ function unwatch():Void; } { })
	...
	@:overload(function(property:Range, callback:{ }):{ function unwatch():Void; } { })
	...
	function setRange(range:Array<Dynamic>):Void;
