...
extern class _SelectStackMixin {
	...
	function onAddChild(pane:dijit._Widget, insertIndex:Float):Void;
	function onRemoveChild(pane:dijit._Widget):Void;
	function onSelectChild(pane:dijit._Widget):Void;
...
extern class BusyButton extends dijit.form.Button {
	...
	@:overload(function(property:BusyLabel, value:String):Void { })
	...
	@:overload(function(property:IsBusy, value:Bool):Void { })
	...
	@:overload(function(property:Timeout, value:Dynamic):Void { })
	...
	@:overload(function(property:UseIcon, value:Bool):Void { })
	...
	@:overload(function(property:BusyLabel):String { })
	...
	@:overload(function(property:IsBusy):Bool { })
	...
	@:overload(function(property:BusyLabel, callback:{ }):{ function unwatch():Void; } { })
	...
	@:overload(function(property:IsBusy, callback:{ }):{ function unwatch():Void; } { })
	...
	@:overload(function(property:UseIcon, callback:{ }):{ function unwatch():Void; } { })
	...
	function postCreate():Void;
	function postMixInProperties():Void;
	function resetTimeout(timeout:Float):Void;
...
extern class CheckedMultiSelect extends dijit.form._FormSelectWidget {
	function new(?params:Dynamic, ?srcNodeRef:HTMLElement):Void;
	var active : Bool;
	@:overload(function(property:Alt, value:String):Void { })
	@:overload(function(property:Aria-label, value:String):Void { })
	...
	@:overload(function(property:Disabled, value:Bool):Void { })
	@:overload(function(property:DomNode, value:HTMLElement):Void { })
	@:overload(function(property:DropDown, value:Bool):Void { })
	@:overload(function(property:Focused, value:Bool):Void { })
	@:overload(function(property:Hovering, value:Bool):Void { })
	@:overload(function(property:Id, value:String):Void { })
	@:overload(function(property:IntermediateChanges, value:Bool):Void { })
	...
	@:overload(function(property:LabelText, value:String):Void { })
	@:overload(function(property:Lang, value:String):Void { })
	...
	@:overload(function(property:Disabled):Bool { })
	@:overload(function(property:DomNode):HTMLElement { })
	@:overload(function(property:DropDown):Bool { })
	@:overload(function(property:Focused):Bool { })
	@:overload(function(property:Hovering):Bool { })
	@:overload(function(property:Id):String { })
	@:overload(function(property:IntermediateChanges):Bool { })
	...
	@:overload(function(property:LabelText):String { })
	@:overload(function(property:Lang):String { })
	...
	@:overload(function(property:LabelText, callback:{ }):{ function unwatch():Void; } { })
	@:overload(function(property:Lang, callback:{ }):{ function unwatch():Void; } { })
	...
	function validate(isFocused:Dynamic):Dynamic;
	function validator():Dynamic;
	function getCachedTemplate():Dynamic;
	function onAfterAddOptionItem(item:Dynamic, option:Dynamic):Void;
	function onBlur():Void;
	function onChange(newValue:Dynamic):Void;
...
extern class DayTextBox extends dojox.form.DateTextBox {
	function new(?params:Dynamic, ?srcNodeRef:HTMLElement):Void;
	var active : Bool;
	@:overload(function(property:Alt, value:String):Void { })
	@:overload(function(property:Aria-label, value:String):Void { })
	...
	function openDropDown():Void;
	function own():Dynamic;
	function parse(displayVal:Dynamic):Dynamic;
	var pattern : { };
	@:overload(function(reference:HTMLElement, position:String):Dynamic { })
	@:overload(function(reference:dijit._WidgetBase, position:String):Dynamic { })
	@:overload(function(reference:String, position:Float):Dynamic { })
...
extern class DropDownSelect extends dijit.form._FormSelectWidget {
	function new(?params:Dynamic, ?srcNodeRef:HTMLElement):Void;
	var active : Bool;
	@:overload(function(property:Alt, value:String):Void { })
	@:overload(function(property:Aria-label, value:String):Void { })
