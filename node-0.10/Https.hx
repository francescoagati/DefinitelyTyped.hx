...
extern class HttpsTopLevel {
	...
	static function request(options:RequestOptions, ?callback:http.ClientResponse -> Void):http.ClientRequest;
	static function get(options:RequestOptions, ?callback:http.ClientResponse -> Void):http.ClientRequest;
