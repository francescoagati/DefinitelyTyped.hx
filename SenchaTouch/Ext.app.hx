...
typedef IApplication = {
	...
	@:optional
	var themeVariation : Dynamic;
	@:optional
	var themeVariationPrefix : String;
	@:optional
	var themeVariationTransitionCls : String;
	@:optional
	...
	@:optional
	function getRequires():Array<String>;
	@:optional
	function getRouter():Ext.app.IRouter;
	@:optional
	function getThemeVariation():Dynamic;
	@:optional
	function getThemeVariationPrefix():String;
	@:optional
	function getThemeVariationTransitionCls():String;
	@:optional
	...
	@:optional
	function setRequires(?requires:Array<String>):Void;
	@:optional
	function setRouter(?router:Ext.app.IRouter):Void;
	@:optional
	function setThemeVariation(?themeVariation:Dynamic):Void;
	@:optional
	function setThemeVariationPrefix(?themeVariationPrefix:String):Void;
	@:optional
	function setThemeVariationTransitionCls(?themeVariationTransitionCls:String):Void;
};
typedef IController = {
	>Ext.IBase,
	...
	@:optional
	function getController(?controllerName:String, ?profile:String):Dynamic;
	@:optional
	function getListeners():Dynamic;
	@:optional
	function getModel(?modelName:String):Dynamic;
	@:optional
