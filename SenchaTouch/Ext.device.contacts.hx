typedef IAbstract = {
	...
	@:optional
	function getContacts(?config:Dynamic):Array<Dynamic>;
	@:optional
	function getIncludeImages():Bool;
	@:optional
	function getListeners():Dynamic;
	@:optional
	function getLocalizedLabel(?config:Dynamic):String;
	@:optional
	function getThumbnail(?config:Dynamic):String;
	@:optional
	...
	@:optional
	function setIncludeImages(?includeImages:Bool):Void;
	@:optional
