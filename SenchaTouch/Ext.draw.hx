...
typedef IComponent = {
	...
	@:optional
	function getGradients():Array<Dynamic>;
	@:optional
	...
	@:optional
	function setGradients(?gradients:Array<Dynamic>):Void;
	@:optional
...
extern class Draw {
	...
	static function getInitialConfig(?name:String):Dynamic;
	static function initConfig(?instanceConfig:Dynamic):Dynamic;
	static function isBBoxIntersect(?bbox1:Dynamic, ?bbox2:Dynamic, ?padding:Float):Bool;
	static function rad(?degrees:Float):Float;
	static function reflectFn(?a:Dynamic):Dynamic;
	static function smooth(?dataX:Dynamic, ?dataY:Dynamic, ?value:Dynamic):Dynamic;
...
typedef IMatrix = {
	...
	var a : Float;
	@:optional
	function append(?xx:Float, ?xy:Float, ?yx:Float, ?yy:Float, ?dx:Float, ?dy:Float):Ext.draw.IMatrix;
	@:optional
	...
	@:optional
	function prepend(?xx:Float, ?xy:Float, ?yx:Float, ?yy:Float, ?dx:Float, ?dy:Float):Ext.draw.IMatrix;
	@:optional
...
extern class Matrix {
	...
	static function createAffineMatrixFromTwoPair(?x0:Float, ?y0:Float, ?x1:Float, ?y1:Float, ?x0p:Float, ?y0p:Float, ?x1p:Float, ?y1p:Float):Void;
	static function createAlias(?alias:Dynamic, ?origin:Dynamic):Void;
	static function createPanZoomFromTwoPair(?x0:Float, ?y0:Float, ?x1:Float, ?y1:Float, ?x0p:Float, ?y0p:Float, ?x1p:Float, ?y1p:Float):Void;
...
typedef IPath = {
	...
	@:optional
	function arcSvg(?rx:Float, ?ry:Float, ?rotation:Float, ?fA:Float, ?fS:Float, ?x2:Float, ?y2:Float):Void;
	@:optional
	...
	@:optional
	function ellipse(?cx:Float, ?cy:Float, ?radiusX:Float, ?radiusY:Float, ?rotation:Float, ?startAngle:Float, ?endAngle:Float, ?anticlockwise:Float):Void;
	@:optional
...
typedef ISegmentTree = {
	...
	@:optional
	function setData(?dataX:Float, ?dataOpen:Float, ?dataHigh:Float, ?dataLow:Float, ?dataClose:Float):Void;
	@:optional
...
extern class Solver {
	...
	static function callParent(?args:Dynamic):Dynamic;
	static function callSuper(?args:Dynamic):Dynamic;
	static function cubicFunction(?a:Float, ?b:Float, ?c:Float, ?d:Float):Void;
	static function cubicRoot(?number:Float):Void;
	static function destroy():Void;
	static function getInitialConfig(?name:String):Dynamic;
	static function initConfig(?instanceConfig:Dynamic):Dynamic;
	static function linearFunction(?a:Float, ?b:Float):Void;
	static function quadraticFunction(?a:Float, ?b:Float, ?c:Float):Void;
	static function statics():Ext.IClass;
}
typedef ISurface = {
	>Ext.IComponent,
	...
	function destroy():Void;
	@:optional
	function getBBox(?sprite:Ext.draw.sprite.ISprite, ?isWithoutTransform:Bool):Dynamic;
	@:optional
	function getBackground():Dynamic;
	@:optional
	...
	@:optional
	function roundPixel(?num:Float):Float;
	@:optional
	function setBackground(?background:Dynamic):Void;
	@:optional
	...
	@:optional
	function waitFor(?surface:Ext.draw.ISurface):Void;
};
extern class Surface {
	...
	static function getName():String;
	static function override(?members:Dynamic):Ext.IBase;
	static function stableSort(?list:Array<Dynamic>):Void;
}
