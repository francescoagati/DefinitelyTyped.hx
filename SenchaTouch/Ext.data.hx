...
typedef IConnection = {
	...
	function onBefore(?eventName:Dynamic, ?fn:Dynamic, ?scope:Dynamic, ?options:Dynamic):Void;
	@:optional
	function parseStatus(?status:Float, ?xhr:XMLHttpRequest):Dynamic;
	@:optional
	function relayEvents(?object:Dynamic, ?events:Dynamic):Ext.mixin.IObservable;
	@:optional
	function removeAfterListener(?eventName:Dynamic, ?fn:Dynamic, ?scope:Dynamic, ?options:Dynamic):Void;
...
typedef IRequest = {
	...
	function getUrl():String;
	@:optional
	function getUseDefaultXhrHeader():Dynamic;
	@:optional
	function getUsername():String;
	@:optional
	function getWithCredentials():Bool;
	...
	function setUrl(?url:String):Void;
	@:optional
	function setUseDefaultXhrHeader(?useDefaultXhrHeader:Dynamic):Void;
	@:optional
	function setUsername(?username:String):Void;
	@:optional
	function setWithCredentials(?withCredentials:Bool):Void;
...
typedef IStore = {
	...
	@:optional
	function addData(?data:Array<Dynamic>):Void;
	@:optional
	...
	function setAutoSync(?autoSync:Bool):Void;
	@:optional
	function setBuffered(?buffered:Bool):Void;
	@:optional
	...
	@:optional
	function setFields(?fields:Dynamic):Dynamic;
	@:optional
	...
	@:optional
	function sync(?options:Dynamic):Dynamic;
};
...
typedef ITreeStore = {
	...
	var root : Dynamic;
	@:optional
	function getById(?id:Dynamic):Dynamic;
	@:optional
...
typedef IXmlWriter = {
	...
	function setRecord(?record:String):Void;
	@:optional
	function writeRecords(?request:Dynamic, ?data:Array<Dynamic>):Dynamic;
};
