...
typedef IFieldSet = {
	...
	var title : String;
	@:optional
	function doSetDisabled(?newDisabled:Dynamic):Ext.form.IFieldSet;
	@:optional
	function getBaseCls():String;
	@:optional
	function setBaseCls(?baseCls:String):Void;
...
typedef IPanel = {
	...
	@:optional
	var enableSubmissionForm : Bool;
	@:optional
	var enctype : Dynamic;
	@:optional
	var method : String;
	@:optional
	var multipartDetection : Bool;
	@:optional
	...
	var url : String;
	@:optional
	var waitMsgTarget : Ext.dom.IElement;
	@:optional
	var waitTpl : Dynamic;
	@:optional
	function doSetDisabled(?newDisabled:Dynamic):Ext.form.IPanel;
	@:optional
	...
	@:optional
	function getEnableSubmissionForm():Bool;
	@:optional
	function getEnctype():Dynamic;
	@:optional
	function getMethod():String;
	@:optional
	function getMultipartDetection():Bool;
	@:optional
	...
	function getRecord():Ext.data.IModel;
	@:optional
	function getStandardSubmit():Bool;
	@:optional
	function getSubmitOnAction():Dynamic;
	@:optional
	function getTimeout():Float;
	@:optional
	function getTrackResetOnLoad():Bool;
	@:optional
	function getUrl():String;
	@:optional
	function getValues(?enabled:Bool, ?all:Bool):Dynamic;
	@:optional
	function hideMask():Ext.form.IPanel;
	@:optional
	function load(?options:Dynamic):Ext.data.IConnection;
	@:optional
	function loadModel(?record:Ext.data.IModel):Ext.form.IPanel;
	@:optional
	function loadRecord(?record:Ext.data.IModel):Ext.form.IPanel;
	@:optional
	function reset():Ext.form.IPanel;
	@:optional
	...
	@:optional
	function setEnableSubmissionForm(?enableSubmissionForm:Bool):Void;
	@:optional
	function setEnctype(?enctype:Dynamic):Void;
	@:optional
	function setMethod(?method:String):Void;
	@:optional
	function setMultipartDetection(?multipartDetection:Bool):Void;
	@:optional
	function setParamOrder(?paramOrder:Dynamic):Void;
	@:optional
	function setParamsAsHash(?paramsAsHash:Bool):Void;
	@:optional
	function setRecord(?record:Ext.data.IModel):Ext.form.IPanel;
	@:optional
	function setStandardSubmit(?standardSubmit:Bool):Void;
	@:optional
	function setSubmitOnAction(?submitOnAction:Dynamic):Void;
	@:optional
	function setTimeout(?timeout:Float):Void;
	@:optional
	function setTrackResetOnLoad(?trackResetOnLoad:Bool):Void;
	@:optional
	function setUrl(?url:String):Void;
	@:optional
	function setValues(?values:Dynamic):Ext.form.IPanel;
	@:optional
	function showMask(?cfg:Dynamic, ?target:Dynamic):Ext.form.IPanel;
	@:optional
	function submit(?options:Dynamic):Ext.data.IConnection;
};
typedef IFormPanel = {
	>Ext.IPanel,
	@:optional
