...
typedef IFile = {
	...
	function setComponent(?component:Dynamic):Void;
	@:optional
	function setMultiple(?multiple:Bool):Void;
};
typedef IFileInput = {
	>Ext.field.IInput,
	@:optional
	...
	var value : Dynamic;
	@:optional
	function applyCapture(?value:Dynamic):Void;
	@:optional
	function getAccept():Dynamic;
	@:optional
	function getCapture():Dynamic;
	@:optional
	...
	function getValue():String;
	@:optional
	function setAccept(?accept:Dynamic):Void;
	@:optional
	function setCapture(?capture:Dynamic):Void;
	@:optional
	function setMultiple(?multiple:Bool):Void;
	@:optional
...
typedef IInput = {
	...
	@:optional
	function setFastFocus(?fastFocus:Bool):Void;
	@:optional
