extern class _SpellCheckScriptMultiPart {
	function new():Void;
	var ACTION_QUERY : String;
	var ACTION_UPDATE : String;
	var callbackHandle : String;
	var delimiter : String;
	var label : String;
	var maxBufferLength : Float;
	var SEC : Float;
	function send(content:String, action:String):Void;
	function setWaitingTime(seconds:Float):Void;
	function onLoad(data:String):Void;
}
extern class _SpellCheckControl extends dijit._Widget {
	function new():Void;
