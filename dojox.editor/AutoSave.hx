extern class _AutoSaveSettingDialog extends dijit._Widget {
	...
	@:overload(function(property:BtnCancel, value:String):Void { })
	@:overload(function(property:BtnOk, value:String):Void { })
	...
	@:overload(function(property:DialogDescription, value:String):Void { })
	@:overload(function(property:DialogTitle, value:String):Void { })
	...
	@:overload(function(property:ParamLabel, value:String):Void { })
	@:overload(function(property:ParamName, value:String):Void { })
	...
	@:overload(function(property:BtnCancel):String { })
	@:overload(function(property:BtnOk):String { })
	...
	@:overload(function(property:DialogDescription):String { })
	@:overload(function(property:DialogTitle):String { })
	...
	@:overload(function(property:ParamLabel):String { })
	@:overload(function(property:ParamName):String { })
	...
	@:overload(function(property:BtnCancel, callback:{ }):{ function unwatch():Void; } { })
	@:overload(function(property:BtnOk, callback:{ }):{ function unwatch():Void; } { })
	...
	@:overload(function(property:DialogDescription, callback:{ }):{ function unwatch():Void; } { })
	@:overload(function(property:DialogTitle, callback:{ }):{ function unwatch():Void; } { })
	...
	@:overload(function(property:ParamLabel, callback:{ }):{ function unwatch():Void; } { })
	@:overload(function(property:ParamName, callback:{ }):{ function unwatch():Void; } { })
...
extern class Breadcrumb extends dijit._editor._Plugin {
	function new(?args:Dynamic):Void;
	var breadcrumbBar : Dynamic;
	var button : Dynamic;
	var command : String;
	var disabled : Bool;
	var editor : Dynamic;
