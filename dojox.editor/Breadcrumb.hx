extern class _BreadcrumbMenuTitle extends dijit._Widget {
	...
	@:overload(function(property:MenuTitle, value:String):Void { })
	...
	@:overload(function(property:MenuTitle):String { })
	...
	@:overload(function(property:MenuTitle, callback:{ }):{ function unwatch():Void; } { })
...
extern class CollapsibleToolbar extends dijit._editor._Plugin {
