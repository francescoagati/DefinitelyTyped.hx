extern class _TextColorDropDown extends dijit._Widget {
	function new():Void;
...
extern class TablePlugins extends dijit._editor._Plugin {
	function new(?args:Dynamic):Void;
...
extern class ToolbarLineBreak extends dijit._Widget {
