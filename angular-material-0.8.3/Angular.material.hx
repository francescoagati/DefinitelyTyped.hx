...
typedef MDConfirmDialog = {
	...
	function cancel(?reason:String):MDConfirmDialog;
};
...
typedef MDDialogService = {
	function show(dialog:haxe.extern.EitherType<MDDialogOptions, MDPresetDialog<Dynamic>>):angular.IPromise<Dynamic>;
