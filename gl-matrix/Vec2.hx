extern class Vec2TopLevel {
	static function create():GLM.IArray;
	static function clone(a:GLM.IArray):GLM.IArray;
	static function fromValues(x:Float, y:Float):GLM.IArray;
	static function copy(out:GLM.IArray, a:GLM.IArray):GLM.IArray;
	static function set(out:GLM.IArray, x:Float, y:Float):GLM.IArray;
	...
	static function transformMat2(out:GLM.IArray, a:GLM.IArray, m:GLM.IArray):GLM.IArray;
	static function transformMat2d(out:GLM.IArray, a:GLM.IArray, m:GLM.IArray):GLM.IArray;
	...
	static function forEach(a:GLM.IArray, stride:Float, offset:Float, count:Float, fn:GLM.IArray -> GLM.IArray -> Dynamic -> Void, arg:Dynamic):GLM.IArray;
	static function forEach(a:GLM.IArray, stride:Float, offset:Float, count:Float, fn:GLM.IArray -> GLM.IArray -> Void):GLM.IArray;
