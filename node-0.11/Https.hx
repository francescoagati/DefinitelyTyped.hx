...
extern class HttpsTopLevel {
	...
	static function request(options:RequestOptions, ?callback:events.EventEmitter -> Void):http.ClientRequest;
	static function get(options:RequestOptions, ?callback:events.EventEmitter -> Void):http.ClientRequest;
