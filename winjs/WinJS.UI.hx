...
extern class CellSpanningLayout {
	...
	function initialize(site:ILayoutSite2, groupsEnabled:Bool):Void;
	function itemsFromRange(firstPixel:Float, lastPixel:Float):Void;
	function layout(tree:ILayoutSite2, changedRange:Dynamic, modifiedItems:Dynamic, modifiedGroups:Dynamic):Void;
	function setupAnimations():Void;
	function uninitialize():Void;
...
extern class Hub {
	...
	function onheaderinvoked(eventInfo:CustomEvent):Void;
	...
	var sectionOnScreen : Float;
	var sections : WinJS.Binding.List<HubSection>;
	var zoomableView : IZoomableView<Dynamic>;
}
...
extern class ListView<T> {
	...
	function onitemdragbetween(eventInfo:CustomEvent):Void;
	function onitemdragchanged(eventInfo:CustomEvent):Void;
	function onitemdragdrop(eventInfo:CustomEvent):Void;
	function onitemdragend(eventInfo:CustomEvent):Void;
	function onitemdragenter(eventInfo:CustomEvent):Void;
	function onitemdragleave(eventInfo:CustomEvent):Void;
	function onitemdragstart(eventInfo:CustomEvent):Void;
...
extern class NavBar {
	...
	function onbeforehide(eventInfo:Event):Void;
	function onbeforeshow(eventInfo:Event):Void;
	function onchildrenprocessed(eventInfo:Event):Void;
	function addEventListener(eventName:String, eventHandler:haxe.Constraints.Function, ?useCapture:Bool):Void;
	function dispatchEvent(type:String, eventProperties:Dynamic):Bool;
	function dispose():Void;
	function hide():Void;
...
extern class NavBarCommand {
	...
	var splitButton : Bool;
	var splitOpened : Bool;
	var state : Dynamic;
	var tooltip : Dynamic;
}
extern class NavBarContainer {
	function new(?element:HTMLElement, ?options:Dynamic):Void;
	function oninvoked(eventInfo:CustomEvent):Void;
	function onsplittoggle(eventInfo:CustomEvent):Void;
	function addEventListener(eventName:String, eventHandler:haxe.Constraints.Function, ?useCapture:Bool):Void;
	function dispatchEvent(type:String, eventProperties:Dynamic):Bool;
	function dispose():Void;
	function forceLayout():Void;
	...
	var data : WinJS.Binding.List<NavBarCommand>;
	var element : HTMLElement;
	var fixedSize : Bool;
...
extern class SearchBox {
	function new(?element:HTMLElement, ?options:Dynamic):Void;
	function onquerychanged(eventInfo:CustomEvent):Void;
	function onquerysubmitted(eventInfo:CustomEvent):Void;
	function onreceivingfocusonkeyboardinput(eventInfo:CustomEvent):Void;
	function onresultsuggestionschosen(eventInfo:CustomEvent):Void;
	function onsuggestionsrequested(eventInfo:CustomEvent):Void;
	function addEventListener(eventName:String, eventHandler:haxe.Constraints.Function, ?useCapture:Bool):Void;
	function dispatchEvent(type:String, eventProperties:Dynamic):Bool;
	function dispose():Void;
	function removeEventListener(eventName:String, eventCallback:haxe.Constraints.Function, ?useCapture:Bool):Void;
	function setLocalContentSuggestionSettings(settings:Dynamic):Void;
	var chooseSuggestionOnEnter : Bool;
	var disabled : Bool;
	var element : HTMLElement;
	var focusOnKeyboardInput : Bool;
	var placeholderText : String;
	var queryText : String;
	var searchHistoryContext : String;
	var searchHistoryDisabled : Bool;
	static function createResultSuggestionImage(url:String):Dynamic;
}
