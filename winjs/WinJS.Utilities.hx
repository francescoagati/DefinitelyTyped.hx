...
extern class WinJS.UtilitiesTopLevel {
	...
	static function getScrollPosition(element:HTMLElement):{ var scrollLeft : Float; var scrollTop : Float; };
	static function getTabIndex(element:HTMLElement):Float;
	...
	static function setScrollPosition(element:HTMLElement, position:{ var scrollLeft : Float; var scrollTop : Float; }):Void;
