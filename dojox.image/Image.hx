...
extern class Badge extends dijit._Widget {
	...
	@:overload(function(property:CellMargin, value:Float):Void { })
	@:overload(function(property:CellSize, value:Float):Void { })
	@:overload(function(property:Children, value:String):Void { })
	...
	@:overload(function(property:Delay, value:Float):Void { })
	@:overload(function(property:Dir, value:String):Void { })
	@:overload(function(property:DomNode, value:HTMLElement):Void { })
	@:overload(function(property:Easing, value:haxe.Constraints.Function):Void { })
	...
	@:overload(function(property:Threads, value:Float):Void { })
	...
	@:overload(function(property:CellMargin):Float { })
	@:overload(function(property:CellSize):Float { })
	@:overload(function(property:Children):String { })
	...
	@:overload(function(property:Delay):Float { })
	@:overload(function(property:Dir):String { })
	@:overload(function(property:DomNode):HTMLElement { })
	@:overload(function(property:Easing):haxe.Constraints.Function { })
	...
	@:overload(function(property:Threads):Float { })
	...
	@:overload(function(property:CellMargin, callback:{ }):{ function unwatch():Void; } { })
	@:overload(function(property:CellSize, callback:{ }):{ function unwatch():Void; } { })
	...
	@:overload(function(property:Delay, callback:{ }):{ function unwatch():Void; } { })
	...
	@:overload(function(property:Easing, callback:{ }):{ function unwatch():Void; } { })
	...
	@:overload(function(property:Threads, callback:{ }):{ function unwatch():Void; } { })
