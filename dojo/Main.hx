...
typedef Text = {
	...
	function normalize(id:Dynamic, toAbsMid:Dynamic):String;
};
typedef Topic = {
	function publish(topic:String, event:Dynamic):Dynamic;
	function subscribe(topic:String, listener:haxe.Constraints.Function):Dynamic;
};
typedef Uacss = { };
typedef Window = {
	function get(doc:HTMLDocument):Dynamic;
